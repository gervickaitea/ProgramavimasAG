...
int main()
{
        ...
        while (true)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    vector<Studentas>::iterator II = S.begin();
                    while (IT != S.end())
                    {
                        if (GP((*II), Vidurkis) >= 5.0 && GP((*II), Mediana) >= 5.0)
                        {
                            Protingi.push_back(*II);
                        }
                        else
                            II++;
                    }
                    ...
                    for (vector<Studentas>::iterator IT = Kvaili.begin(); IT != Kvaili.end(); IT++)
                    {
                        ...
                        if (AverageChoice == 1)
                            IrasymasKvaili << std::fixed << setprecision(2) << GP((*IT), Vidurkis) << setprecision(prec) << endl;
                        else
                            IrasymasKvaili << std::fixed << setprecision(2) << GP((*IT), Mediana) << setprecision(prec) << endl;
                    ...
                    for (vector<Studentas>::iterator IT = Protingi.begin(); IT != Protingi.end(); IT++)
                    {
                        ...
                        streamsize prec = cout.precision();
                        if (AverageChoice == 1)
                            IrasymasProtingi << std::fixed << setprecision(2) << GP((*IT), Vidurkis) << setprecision(prec) << endl;
                        else
                            IrasymasProtingi << std::fixed << setprecision(2) << GP((*IT), Mediana) << setprecision(prec) << endl;
                    }
                    for (auto i = 0; i != IlgiausiasVardas + IlgiausiaPavarde + 10; i++)
    ...
    if (EntryChoice == 3)
    {
        {
            int a;
            cout << "Norite generuoti failus (1) ar naudoti jau sugeneruotus (0) ?";
        label:
            cin >> a;
            if (a == 1)
                ...
                if (a != 1 and a != 0)
                {
                    cout << "toks variantas negalimas, iveskite kita skaiciu ";
                    goto label;
                }
